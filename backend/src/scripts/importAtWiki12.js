...
const logPath = '/home/kacho/src/github.com/neon-uriel/IIDX-Tier-Tracker/backend/import_atwiki_12.log';
const TARGET_LEVEL = 12;
...
async function main() {
    ...
    try {
        ...
        try {
            // Get all Level songs from DB for efficient matching
